...
public void isIntersect(Date Start1,Date end1, Date Start2, Date end2){
...
public class Date {
    ...
    public static void isIntersect(Date in1, Date out1, Date in2, Date out2){



        if (((in1.compareTo(out2) == 0 ) || (in1.compareTo(out2)) == -1) && ((in2.compareTo(out1) == 0) || (in2.compareTo(out1)) == -1)) {



            System.out.println("Same date present.");
            ...
            System.out.println("There are no identical dates.");
